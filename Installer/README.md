...
```text
artifacts/
├─ WAPL-Launcher-v0.1.1.zip
├─ WAPL-Launcher-v0.1.1.zip.sha256
└─ WebAppLauncher-Setup-v0.1.1.exe
```

Upload the launcher ZIP and checksum to the `v0.1.1` GitHub release. Upload
